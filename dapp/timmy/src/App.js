...
import CreatePlantFrom from './component/org';
...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      account: '',
      privateKey: '',
      orgAddress: '0x63cD464823c8CA6592104126e64a8Fb229F19762',
      orgAbi: orgAbi
    }
  }
    ...
    return (
      ...
      <div>
        {/* {this.state.accounts.map((i, idx) => (
         ...
         <h5>UserAddress: {this.state.account} </h5>
        ...
        <CreatePlantFrom web3={this.state.web3} account={this.state.account}
          orgAddress={this.state.orgAddress} orgAbi={this.state.orgAbi}/>
      </div>
    );
  }
}
